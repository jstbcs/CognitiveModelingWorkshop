...
- Comparing models fit via maximum likelihood
...
- You need the Binomial probability function:
...
- More examples (e.g. linear regression?)
- Model comparison via AIC and BIC?
- Multiple starting values
- Fitting to individuals vs the aggregate?
