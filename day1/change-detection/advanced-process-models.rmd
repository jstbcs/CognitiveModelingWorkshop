...
## General High-Threshold Model {.smaller}

Let's go back to the change-detection example. How would we fit a general high-threshold version of the fixed-capacity model? We do!
